...
1. Navigate to the Dashboard URL:
   👉 **[https://auth-provider-omega.vercel.app/auth/dashboard](https://auth-provider-omega.vercel.app/auth/dashboard)**
...
- **Method:** `POST`
- **URL:** `https://auth-provider-omega.vercel.app/api/authorize`
...
- **Method:** `POST`
- **URL:** `https://auth-provider-omega.vercel.app/api/track-logout`
- **Headers:** `Content-Type: application/json`
